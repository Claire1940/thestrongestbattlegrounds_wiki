...
export default function HomePageClient({
  ...
  const siteUrl =
    process.env.NEXT_PUBLIC_SITE_URL || "https://thestrongestbattlegrounds.wiki";
    ...
    "@graph": [
      {
        ...
        image: {
          ...
          width: 1920,
          height: 1080,
          caption: "The Strongest Battlegrounds Gameplay Preview",
        },
        potentialAction: {
          "@type": "SearchAction",
      ...
      },
      {
        ...
        name: "The Strongest Battlegrounds Wiki",
        alternateName: "The Strongest Battlegrounds",
        url: siteUrl,
        description:
          "Community resource hub for The Strongest Battlegrounds codes, tier lists, character guides, combos, controls, and update tracking.",
        logo: {
          "@type": "ImageObject",
        ...
        image: {
          ...
          width: 1920,
          height: 1080,
          caption: "The Strongest Battlegrounds Wiki Hero Image",
        },
        sameAs: [
          "https://www.roblox.com/games/10449761463/The-Strongest-Battlegrounds",
          "https://www.roblox.com/communities/12013007/Yielding-Arts",
          "https://discord.com/invite/yieldingarts",
          "https://www.youtube.com/channel/UCUGiD7a1tYUhSYFHEOM3eFw",
        ],
      },
      {
        "@type": "VideoGame",
      ...
      {
        "@type": "VideoObject",
        name: "The Strongest Battlegrounds - Gameplay Showcase",
        description:
          "Gameplay showcase for The Strongest Battlegrounds featuring combat movement and anime PvP mechanics.",
        uploadDate: "2026-05-16",
        thumbnailUrl: `${siteUrl}/images/hero.webp`,
        embedUrl: "https://www.youtube.com/embed/DgZ_UV-xAZw",
        url: "https://www.youtube.com/watch?v=DgZ_UV-xAZw",
      },
    ],
  };
      ...
      <section className="px-4 py-10 md:py-12">
        <div className="scroll-reveal container mx-auto max-w-6xl">
          <div className="relative overflow-hidden rounded-2xl">
            <VideoFeature
              videoId="DgZ_UV-xAZw"
              title="The Strongest Battlegrounds - Gameplay Showcase"
            />
          </div>
        </div>
      </section>
            ...
            {t.modules.lucidBlocksCreaturesAndEnemies.creatures.map(
              (c: any, index: number) => (
                ...
                >
                  <div className="mb-3">
                    <span
                      className={`text-xs px-2 py-1 rounded-full border ${["Hostile Enemy", "Major Threat", "Elite Threat"].includes(c.role) ? "bg-[hsl(var(--nav-theme)/0.18)] border-[hsl(var(--nav-theme)/0.4)] text-[hsl(var(--nav-theme-light))]" : "bg-[hsl(var(--nav-theme)/0.1)] border-[hsl(var(--nav-theme)/0.3)]"}`}
                    >
                      {c.role}
                    </span>
                  </div>
              ...
              (p: any, index: number) => (
                ...
                >
                  <div className="flex items-center gap-2 mb-3">
                    ...
                    <span
                      className={`text-xs px-2 py-1 rounded-full border ${p.priority === "Essential" ? "bg-[hsl(var(--nav-theme)/0.18)] border-[hsl(var(--nav-theme)/0.4)] text-[hsl(var(--nav-theme-light))]" : p.priority === "Very High" ? "bg-orange-500/10 border-orange-500/30 text-orange-400" : "bg-[hsl(var(--nav-theme)/0.1)] border-[hsl(var(--nav-theme)/0.3)]"}`}
                    >
                      {p.priority}
                    </span>
                  </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-3">
                  <a
                    href="https://discord.com/invite/yieldingarts"
                    target="_blank"
                    rel="noopener noreferrer"
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                ...
                <li>
                  <a
                    href="https://www.roblox.com/communities/12013007/Yielding-Arts"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-muted-foreground hover:text-[hsl(var(--nav-theme-light))] transition"
                  >
                ...
                <li>
                  <a
                    href="https://www.youtube.com/channel/UCUGiD7a1tYUhSYFHEOM3eFw"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-muted-foreground hover:text-[hsl(var(--nav-theme-light))] transition"
                  >
